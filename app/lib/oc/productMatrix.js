/**
 * Created by Coverdale Solutions on 1/21/2017.
 */
...
function productmatrix() {
    ...
    function template() {
        return [
            ...
            '<div class="col-xs-1" ng-hide="displayOnOrder"><div>{{\'On Order\' | r}}</div><div ng-repeat="item in group | orderobjectby:\'ListOrder\':false | filter:{Show: true}">{{item.OrderQuantity}}</div></div>',
